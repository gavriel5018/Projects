...
if(isset($_POST['submit'])){
    ...
    if(! $article || mb_strlen($article) < 2){
        $errors['article'] = 'article must be at least 2 characters';
        $form_valid = false;
    }
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 text-center">
                <form action="" method="POST" autocomplete="off" novalidate="novalidate">
                    ...
                    <button class="btn btn-dark text-danger w-25" type="submit" name="submit">Post</button>
                    <a class="ml-2 btn btn-dark text-danger w-25" href="blog.php">Cancel</a>
                </form>
            </div>
        </div>
    </div>
